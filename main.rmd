...
kable(table_ESTADO, caption = "Tabela de Estados com número de acidentes", col.names = c("Estado", "Número de Acidentes"))
```
...
```{r, echo = FALSE}
acidentes_ordem_decresc <- sort(table_ESTADO$Voos, decreasing = TRUE)
barplot(acidentes_ordem_decresc, names.arg = table_ESTADO$STATE, col = "skyblue", 
        main = "Gráfico de acidentes nos estados dos EUA", xlab = "Total de Acidentes nos estados ", 
        ylab = "Num. acidentes" ) 
```
